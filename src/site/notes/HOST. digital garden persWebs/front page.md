...
This website is organized by connection. Rather than a chronology for finished articles, it's a special venue for *a network of evolving notes*–ideas that get tended, expanded, and linked to one another as understanding deepens. One can navigates threads related to topics following natural advancement. The powerful graph view of "backlinks" reveals hidden angles. All pages reject finality and remain in conversation with old emergence and new proficiency.
